...
def create_and_add_spotify_dialog():
    ...
    def step2_content(context: DialogContext):
        ...
        st.info(
            "Visit the following URL to authorize Syncphony to access your Spotify account.  \n**You will be redirected to an invalid URL, copy and paste it below.**")
    ...
    def validate_step2(context: DialogContext) -> tuple[bool, str, dict]:
        ...
        if not context.get("redirect_url"):
            return False, "Please enter the URL you were redirected to after authorizing Syncphony.", {}
    ...
    step2 = DialogStep(
        title="Step 2: Authorize Syncphony",
...
def spotify_accounts_table():
    ...
    if profiles:
        ...
        display_table(
            ...
            text="Here you can see all the Spotify accounts that you have added to Syncphony.",
            border=True,
            header=True,
            align="left",
            gap="small",
...
def create_and_add_tidal_dialog():
    def step1_content(context: DialogContext):
        ...
        st.info(
            "Visit the following URL to authorize Syncphony to access your TIDAL account.  \n**You will be redirected to an invalid URL, copy and paste it below.**")
    ...
    # Create the dialog steps
    step1 = DialogStep(
        title="Step 1: Authorize Syncphony",
        content=step1_content,
        validation_func=validate_step1,
        next_button_text="Connect"
    )
...
def tidal_accounts_table():
    ...
    if profiles:
        ...
        display_table(
            data=data,
            columns=[3, 2],  # Aligned column widths
            text="Here you can see all the TIDAL accounts that you have added to Syncphony.",
            border=True,
            header=True,
            align="left",
            gap="small",
...
def jellyfin_servers_table():
    ...
    if profiles:
        ...
        display_table(
            data=data,
            columns=[3, 2],  # Aligned column widths
            text="Here you can see all the Jellyfin servers that you have added to Syncphony.",
            border=True,
            header=True,
            align="left",
            gap="small",
...
def subsonic_servers_table():
    ...
    if profiles:
        ...
        display_table(
            ...
            text="Here you can see all the Subsonic accounts that you have added to Syncphony.",
            border=True,
            header=True,
            align="left",
            gap="small",
...
st.write("Here you can manage all the accounts that you have added to Syncphony.")
